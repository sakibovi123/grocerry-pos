...
class GrocerryBrand(models.Model):
...
class GrocerryCategory(models.Model):
    shop = models.ForeignKey(Shop, on_delete=models.SET_NULL, null=True)
...
class Item(models.Model):
    ...
    brand = models.ForeignKey(
        GrocerryBrand, on_delete=models.SET_NULL, null=True, blank=True)
    category = models.ForeignKey(GrocerryCategory, on_delete=models.SET_NULL, null=True)
